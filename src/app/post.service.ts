...
export class PostService {
  ...
  deleteButton(index: number) {
    ...
    this.http.delete(`https://cc105-project-default-rtdb.asia-southeast1.firebasedatabase.app/${index}.json`).subscribe(() => {
      console.log('Post deleted from Firebase');
    });
  }
  addPost(post: Post) {
    this.listOfPosts.push(post);
    this.http.put(`https://cc105-project-default-rtdb.asia-southeast1.firebasedatabase.app/`, this.listOfPosts)
      .subscribe(response => {
  ...
  likePost(index: number) {
    ...
    this.http.put(`https://cc105-project-default-rtdb.asia-southeast1.firebasedatabase.app/${index}.json`, this.listOfPosts[index])
      .subscribe(() => {
  ...
  editComment(postIndex: number, commentIndex: number, newComment: string) {
    ...
    // Update the post in Firebase
    this.http.put(`https://cc105-project-default-rtdb.asia-southeast1.firebasedatabase.app/${postIndex}.json`, this.listOfPosts[postIndex])
      .subscribe(() => {
